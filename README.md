...
- `allocate` / `deallocate` / `distribute` — ops that refresh the implicit heartbeat (`lastActiveAt`)
- `setVetoPeriod` — inactivity window before Grinders is stale (1–30 days; default 7)
- `_authorizeUpgrade` — UUPS implementation swap
