...
This document is the canonical allocation and utility spec until a `GRS` contract ships.
...
| Networks               | **Solana**, **Ethereum**, **Arbitrum**                                                                    |
| Standard               | SPL (Solana) · ERC-20 (Ethereum, Arbitrum)                                                                |
...
![GRS genesis allocation — 1B supply treemap](grs-genesis-alloc.png)

Source: `[grs.svg](grs.svg)` · PNG: `[grs-genesis-alloc.png](grs-genesis-alloc.png)`

![GRS vesting schedule](grs-vesting.png)
...
| Bucket                                | Share       | GRS (18 dec)      | TGE liquid           | Vesting                        |
| ------------------------------------- | ----------- | ----------------- | -------------------- | ------------------------------ |
| **Investments**                       | **20.00%**  | **200,000,000**   | **5% at TGE**        | per round ↓                    |
| ↳ Token sales                          | 5.00%       | 50,000,000        | 5% at TGE            | none (unlocked at TGE)         |
| ↳ Pre-seed                            | 5.00%       | 50,000,000        | 0%                   | no cliff, 2y linear            |
| ↳ Seed                                | 5.00%       | 50,000,000        | 0%                   | 3m cliff, 2y linear            |
| ↳ Series                              | 5.00%       | 50,000,000        | 0%                   | 6m cliff, 24m linear           |
| **Affiliates & airdrops**              | **20.00%**  | **200,000,000**   | **0% at TGE**        | per bucket ↓                   |
| ↳ Revenue Share Program            | 18.00%      | 180,000,000       | 18% TGE              | proprietary-gated · ∞          |
| ↳ Airdrops                             | 2.00%       | 20,000,000        | 2% TGE               | proprietary-gated · 67 seasons |
| **Team**                              | **20.00%**  | **200,000,000**   | **0%**               | per bucket ↓                   |
| ↳ Core team                           | 15.00%      | 150,000,000       | 0%                   | 12m cliff, 60m linear          |
| ↳ Advisors                            | 5.00%       | 50,000,000        | 0%                   | 6m cliff, 66m linear           |
| **Ecosystem**                         | **20.00%**  | **200,000,000**   | **per bucket ↓**     | —                              |
| ↳ Growth Fund                         | 12.00%      | 120,000,000       | 12% TGE              | vote-gated · ∞                 |
| ↳ Liquidity Providing & Market Makers | 8.00%       | 80,000,000        | 8% TGE               | proprietary-gated · ∞          |
| **Foundation**                        | **20.00%**  | **200,000,000**   | **5% at TGE**        | remainder vote-gated · ∞       |
| ↳ Long-term reserve                   | 15.00%      | 150,000,000       | 0%                   | GRS vote                       |
| ↳ Audits                              | 3.00%       | 30,000,000        | 0%                   | GRS vote                       |
| ↳ Legal                               | 2.00%       | 20,000,000        | 0%                   | GRS vote                       |
...
| **Foundation**           | 20%   | 200M | 5% TGE; remainder vote-gated — see §3.5                          |
...
| **Foundation**                            | Protocol reserve — **5% TGE**, remainder vote-gated (**200M GRS**); sub-buckets + §3.5          |
| ↳ **Long-term reserve**                   | Strategic treasury & future ecosystem needs (**15%** / 150M GRS)                                |
| ↳ **Audits**                              | Security audits & bug bounties (**3%** / 30M GRS)                                               |
...
Linear buckets use **non-upgradeable** vesting escrows (`released()` public; `revoke` disabled). Vote-gated remainder (Growth Fund, Foundation 15%) requires a **GRS proposal → vote → timelock** (≥ 48h). **Revenue Share (18%)**, **LP & MM (8%)**, and **Airdrops (2%)** are **proprietary-gated**: team / ops may deploy them from TGE with no GRS vote. Revenue Share and LP have no calendar end; airdrops run **67 seasons**.

### 3.5 Foundation — use of funds
